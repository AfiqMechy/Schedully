...
class SchedullyApp {
  ...
  applyDynamicThemeToElements(theme) {
    ...
    // Dynamic Ambient Lighting behind glass (Mobile, Tablet & Desktop)
    if (isDark) {
      document.body.style.backgroundColor = '#07090E';
      document.body.style.backgroundImage = `radial-gradient(at 10% 15%, ${primary}38 0px, transparent 55%), radial-gradient(at 90% 85%, ${container}30 0px, transparent 55%), radial-gradient(at 50% 50%, #0B101D 0px, #07090E 100%)`;
    } else {
      document.body.style.backgroundColor = '#F1F5F9';
      document.body.style.backgroundImage = `radial-gradient(at 10% 15%, ${container}70 0px, transparent 50%), radial-gradient(at 90% 85%, ${primary}25 0px, transparent 50%), #F1F5F9`;
    }
